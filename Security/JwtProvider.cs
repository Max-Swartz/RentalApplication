...
namespace RentalApplicationAPI.Security
{
    public class JwtProvider
    {
        ...
        public static readonly string Issuer = "Property";
        public static string TokenEndPoint = "/api/connect/token";
        public JwtProvider(RequestDelegate next, PropertyContext db, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager)
        {
            _next = next;
